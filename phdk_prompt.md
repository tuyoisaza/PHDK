...
Before using this prompt, replace `[PHDK_STANDARDS_REPO_URL]` with the real URL of your reusable PHDK standards repository.
...
- `BOOTSTRAP_MONOREPO_PROMPT.md` — Repo setup prompt
...
Standards repo: [PHDK_STANDARDS_REPO_URL]
```
...
`Fetch the latest generic standards from the standards repo. Set up the project repository using BOOTSTRAP_MONOREPO_PROMPT.md. Report back with repo structure and confirmation.`
